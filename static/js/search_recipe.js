        ...
        $.ajax({
          ...
          if (!$.isEmptyObject(data)){
            ...
            $.each(data,function(aa,bb){
              ...
              $('#data_list').append("<li><div class='recipe_list'><div class='left'><span name='food_name'>"+aa+"</span></div><div class='right'><div class='left_rev'><a href='rev_recipe?key="+encodeURI(Base64.encode(Base64.encode(bb)))+"'class='rev'>修改</a></div><div class='right_del'><a href='#' class='del_recipe' data-val='"+bb+"'>刪除</a></div></div></div></li>");
